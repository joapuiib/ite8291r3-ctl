...
def main():
    ...
    parser_anim.add_argument('--loop', nargs='?', const=True, default=1, type=valid_intrange(1),
                             help='Repeat the animation this number of times. Omit the argument to repeat indefinitely.')
    ...
    parser_query.add_argument('-b', '--brightness', action='store_true', help='Get the current brightness.')
